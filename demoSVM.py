...
joined_data = parser.add_feature_to_data_alt(data, 'initial_features_edited.csv', '(Eurozone Bluechip Index) SX5E Index')
data = joined_data[0]
feature_value_range['(Eurozone Bluechip Index) SX5E Index'] = joined_data[1]
...
target = []
target_val = parser.add_feature_to_data(target, 'EURUSD_complete.csv', 'Close')
